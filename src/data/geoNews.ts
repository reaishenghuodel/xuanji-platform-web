...
export const geoNews: GeoNewsItem[] = [
 {
   ...
   summary: `2026年全球生成式AI活跃用户规模突破20亿，GEO从可选项变为必选项，超72%规模级企业已将GEO纳入年度战略预算。市场规模突破数百亿元。`,
...
行业共识：品牌需从「让用户看到」转向「让AI说出」，提前布局结构化语义体系。`,
   source: '凤凰网',
   date: '2026-09-18',
   tags: ['GEO行业', 'AI搜索优化', '品牌营销'],
 },
 {
   id: 284,
   title: `2026年Agent AI从通用对话到可信生产力的范式重构`,
   summary: `企业级AI进入可信智能体时代，DeepMiner凭借98.9%操作准确率和30万+动作空间导航能力成为行业标杆。国内AI智能体服务商突破300家。`,
...
- 2025年全球AI智能体市场规模突破8.5万亿元，中国市场年增长率达72.7%`,
   source: '腾讯云开发者社区',
   date: '2026-09-18',
   tags: ['AI智能体', 'Agent', '可信生产力', '企业应用'],
 },
 {
   id: 283,
   title: `GEO全解析：品牌如何抢占AI搜索推荐新入口`,
   summary: `GEO市场规模突破数百亿元，超72%规模级企业已将GEO纳入年度战略预算。全链路GEO服务体系从语义校准到效果量化逐步成熟。`,
